...
public class ClientFrasesAleatorias {
    ...
    public ClientFrasesAleatorias(int portValue, String strIp) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ClientFrasesAleatorias cvel = new ClientFrasesAleatorias(5557, "224.0.11.111");
        cvel.runClient();
